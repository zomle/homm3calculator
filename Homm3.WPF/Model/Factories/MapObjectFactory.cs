...
namespace Homm3.WPF
{
	public static class MapObjectFactory
	{
		...
		private static IEnumerable<MapObject> ListAdventureMapObjects()
		{
			...
			yield return new MapObject("Pandora's Box (tier 1 monster)", 5000, "Pandora's Box monster 1");
			yield return new MapObject("Pandora's Box (tier 2 monster)", 7000, "Pandora's Box monster 2");
			yield return new MapObject("Pandora's Box (tier 3 monster)", 9000, "Pandora's Box monster 3");
			yield return new MapObject("Pandora's Box (tier 4 monster)", 12000, "Pandora's Box monster 4");
			yield return new MapObject("Pandora's Box (tier 5 monster)", 16000, "Pandora's Box monster 5");
			yield return new MapObject("Pandora's Box (tier 6 monster)", 21000, "Pandora's Box monster 6");
			...
			yield return new MapObject("Seer's Box (tier 1 monster)", 5000, "Seer's Box monster 1");
			yield return new MapObject("Seer's Box (tier 2 monster)", 7000, "Seer's Box monster 2");
			yield return new MapObject("Seer's Box (tier 3 monster)", 9000, "Seer's Box monster 3");
			yield return new MapObject("Seer's Box (tier 4 monster)", 12000, "Seer's Box monster 4");
			yield return new MapObject("Seer's Box (tier 5 monster)", 16000, "Seer's Box monster 5");
			yield return new MapObject("Seer's Box (tier 6 monster)", 21000, "Seer's Box monster 6");
			yield return new MapObject("Seer's Box (tier 7 monster)", 27000, "Seer's Box monster 7");
